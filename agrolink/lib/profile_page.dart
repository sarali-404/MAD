    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      showDialog(
        ...
        builder: (context) => AlertDialog(
          title: const Text('Firestore Permissions Issue'),
          content: Column(
            mainAxisSize: MainAxisSize.min,
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              const Text('Unable to access your profile data due to Firebase security rules.'),
              const SizedBox(height: 10),
              const Text('To fix this, update your Firestore rules in the Firebase Console:'),
              const SizedBox(height: 10),
              Container(
